...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/template/css/owl.theme.css')}}">
    <link rel="stylesheet" href="{{ asset('assets/template/css/owl.transitions.css')}}">
    <!-- animate CSS
		============================================ -->
    ...
    <!-- morrisjs CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('assets/template/css/morrisjs/morris.css')}}">
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('assets/template/css/scrollbar/jquery.mCustomScrollbar.min.css')}}">
    <!-- metisMenu CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('assets/template/css/metisMenu/metisMenu.min.css')}}">
    <link rel="stylesheet" href="{{ asset('assets/template/css/metisMenu/metisMenu-vertical.css')}}">
    <!-- calendar CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('assets/template/css/calendar/fullcalendar.min.css')}}">
    <link rel="stylesheet" href="{{ asset('assets/template/css/calendar/fullcalendar.print.min.css')}}">
    <!-- style CSS
		============================================ -->
...
<body>
        ...
        <div class="left-sidebar-pro">
            <nav id="sidebar" class="">
                <div class="sidebar-header">
                    <a href="index"><img class="main-logo" src="assets/template/img/logo/logo.jpg" alt="" /></a>
                <strong><img src="assets/template/img/logo/logosn.png" alt="" /></strong>
            </div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index">
								   ...
								   <span class="mini-click-non">Peminjaman Buku</span>
								</a>
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="peminjaman" href="/admin/peminjaman"><i class="fa fa-circle-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Peminjaman</span></a></li>
                                <li><a title="peminjam" href="/admin/peminjam"><i class="fa fa-circle-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Peminjam</span></a></li>
                                <li><a title="penerbit" href="/admin/penerbit"><i class="fa fa-circle-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Penerbit</span></a></li>
                                <li><a title="petugas" href="/admin/petugas"><i class="fa fa-circle-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Petugas</span></a></li>
                                <li><a title="buku" href="/admin/buku"><i class="fa fa-circle-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Buku</span></a></li>
                                <li><a title="detail_peminjaman" href="/admin/detail_peminjaman"><i class="fa fa-circle-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Detail Peminjaman</span></a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            {{-- <li><span class="bread-blod">Dashboard V.</span>
                                            </li> --}}
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="single-new-trend mg-t-30">
                            <a href="#"><img src="assets/template/img/new-product/5.jpg" alt=""></a>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="single-new-trend mg-t-30">
                            <a href="#"><img src="assets/template/img/new-product/6.jpg" alt=""></a>
                            <div class="overlay-content">
                                <a href="#">
                                    <h2>$280</h2>
                                </a>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="single-new-trend mg-t-30">
                            <a href="#"><img src="assets/template/img/new-product/7.jpg" alt=""></a>
                            <div class="overlay-content">
                                <a href="#">
                                    <h2>$280</h2>
                                </a>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="personal-info-wrap">
                            <div class="widget-head-info-box">
                                ...
                                <img src="assets/template/img/notification/5.jpg" class="img-circle circle-border m-b-md" alt="profile">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="author-widgets-single res-mg-t-30">
                            <div class="author-wiget-inner">
                                <div class="perso-img">
                                    <img src="assets/template/img/notification/6.jpg" class="img-circle circle-border m-b-md" alt="profile">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="personal-info-wrap personal-info-ano res-mg-t-30">
                            <div class="widget-head-info-box">
                                ...
                                <img src="assets/template/img/contact/2.jpg" class="img-circle circle-border m-b-md" alt="profile">
                                <div class="social-widget-result">
                                    <span>100 Tweets</span> |
                                    <span>350 Following</span> |
                                    <span>610 Followers</span>
    ...
    <!-- jquery
		============================================ -->
    <script src="{{ asset('assets/template/js/vendor/jquery-1.11.3.min.js')}}"></script>
    <!-- bootstrap JS
		============================================ -->
    ...
    <!-- price-slider JS
		============================================ -->
    <script src="{{ asset('assets/template/js/jquery-price-slider.js')}}"></script>
    <!-- meanmenu JS
		============================================ -->
    <script src="{{ asset('assets/template/js/jquery.meanmenu.js')}}"></script>
    <!-- owl.carousel JS
		============================================ -->
    <script src="{{ asset('assets/template/js/owl.carousel.min.js')}}"></script>
    <!-- sticky JS
		============================================ -->
    <script src="{{ asset('assets/template/js/jquery.sticky.js')}}"></script>
    <!-- scrollUp JS
		============================================ -->
    <script src="{{ asset('assets/template/js/jquery.scrollUp.min.js')}}"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    <script src="{{ asset('assets/template/js/scrollbar/jquery.mCustomScrollbar.concat.min.js')}}"></script>
    <script src="{{ asset('assets/template/js/scrollbar/mCustomScrollbar-active.js')}}"></script>
    <!-- metisMenu JS
		============================================ -->
    <script src="{{ asset('assets/template/js/metisMenu/metisMenu.min.js')}}"></script>
    <script src="{{ asset('assets/template/js/metisMenu/metisMenu-active.js')}}"></script>
    <!-- morrisjs JS
		============================================ -->
    <script src="{{ asset('assets/template/js/morrisjs/raphael-min.js')}}"></script>
    <script src="{{ asset('assets/template/js/morrisjs/morris.js')}}"></script>
    <script src="{{ asset('assets/template/js/morrisjs/morris-active.js')}}"></script>
    <!-- morrisjs JS
		============================================ -->
    <script src="{{ asset('assets/template/js/sparkline/jquery.sparkline.min.js')}}"></script>
    <script src="{{ asset('assets/template/js/sparkline/jquery.charts-sparkline.js')}}"></script>
    <!-- calendar JS
		============================================ -->
    <script src="{{ asset('assets/template/js/calendar/moment.min.js')}}"></script>
    <script src="{{ asset('assets/template/js/calendar/fullcalendar.min.js')}}"></script>
    <script src="{{ asset('assets/template/js/calendar/fullcalendar-active.js')}}"></script>
    <!-- plugins JS
		============================================ -->
